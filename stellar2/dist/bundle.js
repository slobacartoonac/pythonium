...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _sunNode_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./sunNode.js */ \"./src/javascript/sunNode.js\");\n/* harmony import */ var _ploter_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./ploter.js */ \"./src/javascript/ploter.js\");\n/* harmony import */ var _touch__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./touch */ \"./src/javascript/touch.js\");\n/* harmony import */ var _drawFPS__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./drawFPS */ \"./src/javascript/drawFPS.js\");\nfunction ownKeys(object, enumerableOnly) { var keys = Object.keys(object); if (Object.getOwnPropertySymbols) { var symbols = Object.getOwnPropertySymbols(object); if (enumerableOnly) symbols = symbols.filter(function (sym) { return Object.getOwnPropertyDescriptor(object, sym).enumerable; }); keys.push.apply(keys, symbols); } return keys; }\n\nfunction _objectSpread(target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i] != null ? arguments[i] : {}; if (i % 2) { ownKeys(Object(source), true).forEach(function (key) { _defineProperty(target, key, source[key]); }); } else if (Object.getOwnPropertyDescriptors) { Object.defineProperties(target, Object.getOwnPropertyDescriptors(source)); } else { ownKeys(Object(source)).forEach(function (key) { Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key)); }); } } return target; }\n\nfunction _defineProperty(obj, key, value) { if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }\n\n\n\n\n\nvar draw = new _ploter_js__WEBPACK_IMPORTED_MODULE_1__[\"default\"](640, 480);\nvar position = {\n  x: 0,\n  y: 0,\n  scale: 1\n};\nwindow.addEventListener('mousewheel', function (e) {\n  position.scale *= e.wheelDelta > 0 ? 1.1 : 0.88;\n});\nvar canvas = draw.getCanvas();\nvar fps = Object(_drawFPS__WEBPACK_IMPORTED_MODULE_3__[\"default\"])(draw.context);\ndocument.body.appendChild(canvas);\nvar touch = new _touch__WEBPACK_IMPORTED_MODULE_2__[\"default\"](canvas, 100);\ntouch.sub('force', function (_ref) {\n  var delta = _ref.delta;\n  position = _objectSpread({}, position, {\n    x: position.x - delta.x / position.scale,\n    y: position.y - delta.y / position.scale\n  });\n});\nvar all = [];\nall.push(new _sunNode_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"]([0, 0], [0, 0], 65, all, 'Sun'));\nall.push(new _sunNode_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"]([255, 0], [0, 8], 3, all, 'Mercury'));\nall.push(new _sunNode_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"]([300, 0], [0, 10], 4, all, 'Venus'));\nall.push(new _sunNode_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"]([450, 0], [0, 10], 7, all, 'Earth'));\nall.push(new _sunNode_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"]([600, 0], [0, 10], 4, all, 'Mars'));\nall.push(new _sunNode_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"]([1400, 0], [0, 10], 25, all, 'Jupiter'));\nall.push(new _sunNode_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"]([1440, 0], [0, 12], 2, all, 'Europa'));\nall.push(new _sunNode_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"]([1450, 0], [0, 12], 2, all, 'Europa'));\nall.push(new _sunNode_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"]([2800, 0], [0, 10], 5, all, 'Saturn'));\n\nvar generateItem = function generateItem(size) {\n  var angle = Math.random() * 2 * Math.PI;\n  var radius = 200 + Math.random() * 2000;\n  var x = Math.sin(angle) * radius;\n  var y = Math.cos(angle) * radius;\n  var tan = Math.atan2(x, y) - Math.PI / 2;\n  var el = new _sunNode_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"]([x, y], [10 * Math.sin(tan) + Math.random() * 14 - 7, 10 * Math.cos(tan) + Math.random() * 14 - 7], size || 0.1 + Math.random(), all);\n  all.push(el);\n};\n\nsetInterval(function () {\n  all.length < 30 && generateItem();\n}, 200);\n\nfunction work() {\n  //draw.clear()\n  //draw.drawMass(all,position)\n  draw.drawMass2(all, position); //draw.grid(100,100,position)\n\n  draw.points(all.map(function (elem) {\n    return [elem.positions[0], elem.positions[1], elem.radius, elem.radius > 7 ? '#ff9933' : '#aaffbb'];\n  }), position);\n  fps();\n  all.forEach(function (e) {\n    e.compute();\n  });\n  var allLength = all.length;\n\n  for (var i = 0; i < allLength; i++) {\n    var first = all.shift();\n    if (!first.invalid) all.push(first);\n  }\n\n  all.forEach(function (e) {\n    e.move();\n  });\n  setTimeout(work, 30);\n}\n\nwork();\n\n//# sourceURL=webpack:///./src/javascript/index.js?");
