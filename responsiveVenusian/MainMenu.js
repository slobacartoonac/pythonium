...
BasicGame.MainMenu.prototype = {
	...
	create: function () {
        ...
        this.spriteMiddle = this.add.sprite(0, 0, 'start');
		this.spriteMiddle.inputEnabled = true;
		this.spriteMiddle.events.onInputDown.add(function(){this.state.start('Game');}, this);
