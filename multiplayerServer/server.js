...
io.on('connection', function (socket) {
	...
	player.setFunctionDest('posgame', function () {
		...
		socket.emit('comfrm', {
			q: 'Game score: ' + player.group.ls + '</br>You\'r score: ' + player.score +
...
function rocking(boxes, group) {
	...
	else if (boxes.b > 299 && boxes.b < 600 && boxes.d > 5) {
		boxes.b++;
		boxes.l = 2;
		if (boxes.l == boxes.ol)
			boxes.d = -1;
	...
	else if (boxes.b > 599 && boxes.b < 900 && boxes.d > 2) {
		boxes.b++;
		boxes.l = 3;
		if (boxes.l == boxes.ol)
			boxes.d = -1;
	...
	else if (boxes.b > 899 && boxes.b < 1200 && boxes.d > 1) {
		boxes.b++;
		boxes.l = 4;
		if (boxes.l == boxes.ol)
			boxes.d = -1;
	...
	else if (boxes.b > 1199 && boxes.d > 0) {
		boxes.b++;
		boxes.l = 5;
		if (boxes.l == boxes.ol)
			boxes.d = -1;
